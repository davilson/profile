        ...
        <div className="row">
          <div className="col-lg-8 text-center text-lg-left">
            ...
            <p>
              ...
              programação e atuo profissionalmente na área há pelo menos 8 anos.
              Atualmente trabalho em projetos que utilizam PHP, Node.js,
              React.js/React Native, HTML5, CSS3, MongoDB, MySQL, Bootstrap e
              Material-Ui.
            </p>
          </div>
